...
public class EmployeeMain {
	...
	public static void main(String[] args) {
		student s1=new student(1,22,"Rahul",50000.5f);
		student s2=new student(2,22,"Vijay",50020.5f);
		student s3=new student(3,20,"Praveen",50022.5f);
		student s4=new student(4,21,"Kumar",50002.5f);
